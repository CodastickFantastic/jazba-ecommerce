...
export async function loader({ request }) {
    const seo = seoPolicy({
        title: 'Regulamin Konta w Sklepie Jazba',
        description: 'Poznaj nasza Regulamin Konta w Sklepie Jazba - Jazba',
        url: request.url
    })
    return json({ seo })
}
...
export default function PolitykaZwrotów() {
    return (
        <div className={`${styles.legal} smallContainer`}>
            <h1>Regulamin Konta w Sklepie Jazba</h1>
            ...
            <div className={styles.contents}>
                ...
                <ol>
                    ...
                    <li><Link to="#konto">Konto</Link></li>
            ...
            <div id="definicje" className={styles.akapit}>
                ...
                <ol style={{ listStyle: "none" }}>
                    <li><strong>Konsument</strong> – Usługobiorca będący osobą fizyczną, który zawarł na podstawie Regulaminu umowę o prowadzenie Konta lub podejmuje czynności zmierzające do jej zawarcia, bez bezpośredniego związku z jego działalnością gospodarczą lub zawodową.</li>
                    <li><strong>Konto</strong> – usługa cyfrowa w rozumieniu Ustawy o prawach konsumenta, świadczona nieodpłatnie drogą elektroniczną przez Usługodawcę na rzecz Usługobiorcy, dzięki której Usługobiorca może skorzystać z dodatkowych funkcji w Sklepie.</li>
                    <li><strong>Przedsiębiorca uprzywilejowany</strong> - Usługobiorca, który jest osobą fizyczną zawierającą na podstawie Regulaminu umowę o prowadzenie Konta (lub podejmującą czynności zmierzające do jej zawarcia), bezpośrednio związaną z jej działalnością gospodarczą, ale nieposiadającą dla niej charakteru zawodowego.</li>
                    <li><strong>Regulamin</strong> - niniejszy regulamin Konta.</li>
                    <li><strong>Sklep</strong> – sklep internetowy Jazba Fashion prowadzony przez Usługodawcę pod adresem https://www.jazba.pl</li>
                    <li><strong>Usługobiorca</strong> - każdy podmiot, który zawarł umowę o prowadzenie Konta lub podejmuje czynności zmierzające do jej zawarcia.</li>
            ...
            <div id="konto" className={styles.akapit}>
                <h2>4. Konto</h2>
                <ol>
                    ...
                    <li>Usługobiorca może bez ponoszenia jakichkolwiek kosztów w każdym czasie zrezygnować z Konta.</li>
                    <li>Usunięcie Konta skutkuje rozwiązaniem umowy o prowadzenie Konta. W celu usunięcia Konta przez Usługodawcę należy wysłać swoją rezygnację z Konta na adres e-mail Usługodawcy podany w § 2 Regulaminu, czego skutkiem będzie niezwłoczne usunięcie Konta oraz rozwiązanie umowy o prowadzenie Konta.</li>
                </ol>
            </div>
