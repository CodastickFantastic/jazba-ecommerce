...
export type CollectionsToShowOnHomeQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type CollectionsToShowOnHomeQuery = {
  al_rancher?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
      image?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Image, 'altText' | 'url'>>;
    }
  >;
  dali_gator?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
      image?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Image, 'altText' | 'url'>>;
...
export type CollectionDetailsQuery = {
  collection?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'title' | 'descriptionHtml' | 'handle'> & {
      metafield?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      image?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Image, 'altText' | 'url'>>;
...
export type ProductQuery = {
  ...
  product?: StorefrontAPI.Maybe<
    Pick<
      ...
      'id' | 'tags' | 'title' | 'handle' | 'descriptionHtml'
    > & {
      metafield?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      priceRange: {
      ...
      images: {
        edges: Array<{
          node: Pick<StorefrontAPI.Image, 'id' | 'url' | 'altText'>;
        }>;
      };
      ...
      selectedVariant?: StorefrontAPI.Maybe<
        Pick<
          StorefrontAPI.ProductVariant,
          'id' | 'quantityAvailable' | 'sku' | 'title'
        > & {
          selectedOptions: Array<
            Pick<StorefrontAPI.SelectedOption, 'name' | 'value'>
          >;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\nquery CollectionsToShowOnHome {\n\tal_rancher: collection(handle: "al-rancher") {\n    id\n\t\ttitle\n    handle\n    image{\n    \taltText\n      url\n    }\n  }\n  \n\tdali_gator: collection(handle: "dali-gator") {\n    id\n\t\ttitle\n    handle\n    image{\n    \taltText\n      url\n    }\n    metafield(key: "likes", namespace: "custom") {\n      value\n    }\n  }\n}': {
    return: CollectionsToShowOnHomeQuery;
    variables: CollectionsToShowOnHomeQueryVariables;
  };
